    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
            ...
            <body>
                ...
                <script src="/Oskari${path}/PLID/main-es2015.9339c41cf2170bc2c013.js" type="module"></script>
                <script src="/Oskari${path}/PLID/main-es5.9339c41cf2170bc2c013.js" nomodule defer></script>
    </body>

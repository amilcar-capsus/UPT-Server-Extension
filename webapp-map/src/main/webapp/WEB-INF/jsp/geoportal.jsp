    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
            ...
            <body>
                ...
                <script src="/Oskari${path}/PLID/main-es2015.a3ac6ad85071719dc637.js" type="module"></script>
                <script src="/Oskari${path}/PLID/main-es5.a3ac6ad85071719dc637.js" nomodule defer></script>
    </body>

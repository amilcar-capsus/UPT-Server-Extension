        ...
        <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
            ...
            <body>
                ...
                <nav id="maptools">
                            ...
                            <%-- If logout url is present - so logout link --%>
                                <c:when test="${!empty _logout_uri}">
                                    <form action="${pageContext.request.contextPath}${_logout_uri}" method="POST" id="logoutform">
                                        ...
                                        <a href="${pageContext.request.contextPath}${_logout_uri}" style="color: #000000;" onClick="jQuery('#logoutform').submit();return false;">
                    ...
                    <div id="demolink">
                        <a href="#" style="margin: 10px; color: #3c3c3c;" onClick="changeAppsetup()">EPSG:3857</a>
                    </div>
                </nav>

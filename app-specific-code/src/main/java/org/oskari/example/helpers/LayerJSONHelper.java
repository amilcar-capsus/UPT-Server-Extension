...
public class LayerJSONHelper {
  ...
  public static JSONObject getDefaultLocale(
    final String fi,
    final String en,
    final String sv
  )
  ...
  public static JSONObject getIDPLocale(final String in, final String en)
    throws JSONException {
    JSONObject json = new JSONObject();
  ...
  public static JSONObject getForcedSRSJSON(String[] crsArray)
    throws JSONException {
    JSONObject json = new JSONObject();
    JSONArray forcedSRS = new JSONArray();
  ...
  public static JSONObject addForceProxySetting(JSONObject json)
    throws JSONException {
    json.put("forceProxy", true);
    return json;
  }

  public static JSONObject getRolePermissionsJSONForRoleAndAdmin(
    String roleName
  )
    throws JSONException {
    JSONObject json = new JSONObject();
  ...
  public static JSONObject getRolePermissionsJSONForPrivateResource(
    String roleName
  )
    throws JSONException {
    JSONObject json = new JSONObject();
  ...
  public static JSONObject getCroppingLayersAttributesJSON(

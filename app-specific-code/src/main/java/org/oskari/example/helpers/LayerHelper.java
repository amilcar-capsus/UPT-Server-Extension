...
public class LayerHelper {
     ...
     */
    public static int addLayers(final JSONArray layerArray, final List<MaplayerGroup> maplayerGroups, final boolean checkExistingLayers, final Connection conn) {
    ...
    public static int addMainGroup(String fiName, String enName, String svName) throws JSONException {
        ...
        try {
            MaplayerGroup group = MAP_LAYER_GROUP_SERVICE.findByName(mainGroup.getLocale().getString("en"));
            if (group != null) {
                return group.getId();
            }
        ...
        return MAP_LAYER_GROUP_SERVICE.insert(mainGroup);
    }

    public static int addSubGroup(final int parentId, final org.json.JSONObject locale, final int order) {
        ...
        try {
            MaplayerGroup group = MAP_LAYER_GROUP_SERVICE.findByName(locale.getString("en"));
            if (group != null) {
                return group.getId();
            }
        } catch (JSONException jex) {

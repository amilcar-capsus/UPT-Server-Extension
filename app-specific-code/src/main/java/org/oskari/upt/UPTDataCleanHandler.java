...
public class UPTDataCleanHandler extends RestActionHandler {
    ...
    private static final Logger log = LogFactory.getLogger(UPTDataCleanHandler.class);
    ...
    public void handleGet(ActionParameters params) throws ActionException {
        ...
        try (
                Connection connection = DriverManager.getConnection(
                        ...
                        upUser,
                        upPassword);
                PreparedStatement statment= connection.prepareStatement("with datafix as(\n" +
                ...
                PreparedStatement statment2= connection.prepareStatement("with datafix as(\n" +

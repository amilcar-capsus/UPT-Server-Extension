...
import org.oskari.upt.PostStatus;
import org.oskari.upt.Tables;
...
public class CopyDataHandler extends RestActionHandler {
        ...
        try {
            ...
            switch (params.getRequiredParam("layerUPName")) {
                ...
                case "mmu_info":
                    ...
                    break;
                case "transit":
                    this.setTransit(params.getRequiredParam("layerUPName"),
                            params.getRequiredParam("layerName"),
                            params.getRequest().getParameterValues("tableUP"),
                            params.getRequest().getParameterValues("table"),
                            params.getRequiredParam("scenarioId"));
                ...
                case "transit_info":
                    ...
                    break;
                case "roads":
                    this.setRoads(params.getRequiredParam("layerUPName"),
                            params.getRequiredParam("layerName"),
                            params.getRequest().getParameterValues("tableUP"),
                            params.getRequest().getParameterValues("table"),
                            params.getRequiredParam("scenarioId"));
                ...
                case "roads_info":
                    ...
                    break;
                case "jobs":
                    this.setJobs(params.getRequiredParam("layerUPName"),
                            params.getRequiredParam("layerName"),
                            params.getRequest().getParameterValues("tableUP"),
                            params.getRequest().getParameterValues("table"),
                            params.getRequiredParam("scenarioId"));
                ...
                case "jobs_info":
                    ...
                    break;
                case "footprint":
                    this.setFootprint(params.getRequiredParam("layerUPName"),
                            params.getRequiredParam("layerName"),
                            params.getRequest().getParameterValues("tableUP"),
                            params.getRequest().getParameterValues("table"),
                            params.getRequiredParam("scenarioId"));
                    ...
                    break;
                case "risk":
                    this.setRisk(params.getRequiredParam("layerUPName"),
                            params.getRequiredParam("layerName"),
                            params.getRequest().getParameterValues("tableUP"),
                            params.getRequest().getParameterValues("table"),
                            params.getRequiredParam("scenarioId"));
                ...
                case "risk_info":
                    ...
                    break;
                case "amenities":
                    this.setAmenities(params.getRequiredParam("layerUPName"),
                            params.getRequiredParam("layerName"),
                            params.getRequest().getParameterValues("tableUP"),
                            params.getRequest().getParameterValues("table"),
                            params.getRequiredParam("scenarioId"));
    ...
    private void setAmenities(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) {
        ...
        try (
            ...
            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Amenities executing query:" + statement.toString()))));
            ...
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/amenities/", final_data, PostStatus.class);
        } catch (Exception e) {
            try {
                errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("Error", e.toString()))));
                errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("Error", e.getMessage()))));
    ...
    private void setAmenitiesInfo(String layerUP, String layer, String[] tableup, String[] table, String scenarioId)  throws Exception{
        ...
        String query = "";
            ...
            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Amenities attribures executing query:" + statement.toString()))));
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/amenities_info/", final_data, PostStatus.class);
    }

    private void setMmu(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        PostStatus postStatus = new PostStatus();
        postStatus.status = "OK";
        String values = "";
        String tableUP[] = new String[tableup.length + 2];
        ...
        String query = "";
            ...
            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Minimum mapping unit executing query:" + statement.toString()))));
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/mmu/", final_data, PostStatus.class);
    }

    private void setMmuInfo(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        String query = "";
            ...
            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Minimum mapping unit attributes executing query:" + statement.toString()))));
            ...
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/mmu_info/", final_data, PostStatus.class);
    }

    private void setTransit(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        String query = "";
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/transit/", final_data, PostStatus.class);
    }

    private void setTransitInfo(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        String query = "";
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/transit_info/", final_data, PostStatus.class);
    }

    private void setRoads(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        String query = "";
            ...
            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Roads executing query:" + statement.toString()))));
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/roads/", final_data, PostStatus.class);
        
    }

    private void setRoadsInfo(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        String query = "";
            ...
            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Roads attributes executing query:" + statement.toString()))));
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/roads_info/", final_data, PostStatus.class);
    }

    private void setJobs(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        String query = "";
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/jobs/", final_data, PostStatus.class);
    }

    private void setJobsInfo(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        String query = "";
            ...
            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Jobs attributes executing query:" + statement.toString()))));
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/jobs_info/", final_data, PostStatus.class);
    }

    private void setFootprint(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        for (int i = 0; i < tableUP.length; i++) {
            switch (tableUP[i]) {
                ...
                case "location":
                    ...
                    values += " st_astext(st_union(st_transform(st_setsrid(" + table[i] + "," + upProjection + "),4326))) as " + tableUP[i];
                    break;
                case "scenario":
                    values += scenarioId + " as " + tableUP[i];
                    break;
        ...
        String query = "";
            ...
            query = "select distinct " + values.replaceAll(",,", ",") + " from user_layer\n"
                    + " inner join user_layer_data on user_layer.id = user_layer_data.user_layer_id\n"
                    + " where user_layer.id=" + layer+" group by "+group;

            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Footprint executing query:" + statement.toString()))));
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/footprint/", final_data, PostStatus.class);
    }

    private void setRisk(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        String query = "";
            ...
            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Risk executing query:" + statement.toString()))));
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/risk/", final_data, PostStatus.class);
        
    }

    private void setRiskInfo(String layerUP, String layer, String[] tableup, String[] table, String scenarioId) throws Exception{
        ...
        String query = "";
            ...
            errors.put(JSONHelper.createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Risk attributes executing query:" + statement.toString()))));
            ...
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.postForObject("http://" + upwsHost + ":" + upwsPort + "/risk_info/", final_data, PostStatus.class);
    }
}
